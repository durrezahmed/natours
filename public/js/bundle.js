...
var stripe = Stripe('pk_test_51KkARsSDXVPTcNyPzb74doER1imbNc7vZvGmJTGFNt9LUl6guaIP0vOwFPXLgRCsu94jS8aOd4ngs6NEotZ8SeHg00bbE9XYEx');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXBwYnVpbGRzIiwiYSI6ImNsMWR5ajB5ZjBtZmszaW5yMnlwdmJxOHkifQ.tXVjUCc8Im5BTaaGh0SeLQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: "mapbox://styles/appbuilds/cl1dyq3l8005b14nx3123568c",
    scrollZoom: false,
    focusAfterOpen: false // center: [-118.113491, 34.111745],
    // zoom: 10,
    // interactive: false,
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              document.querySelector('.btn--save-password').textContent = 'Save password'; // clearing fields
